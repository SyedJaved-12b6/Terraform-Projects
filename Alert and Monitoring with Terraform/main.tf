# Resource Group
resource "azurerm_resource_group" "syedapp_rg" {
  name     = "syed-provisioner-demo-rg"
  location = "East US"
}

# Virtual Network
resource "azurerm_virtual_network" "main" {
  name                = "syed-demo-network"
  address_space       = ["10.0.0.0/16"]
  location            = azurerm_resource_group.syedapp_rg.location
  resource_group_name = azurerm_resource_group.syedapp_rg.name
}
